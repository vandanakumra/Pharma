...
namespace PharmaUI
{
    ...
    public partial class frmPurchaseHeaderAmount : Form
    {
        ...
        public frmPurchaseHeaderAmount(PurchaseSaleBookHeader header)
        {
            ...
            //purchaseBookHeader = applicationFacade.GetFinalAmountWithTaxForPurchase(header.PurchaseSaleBookHeaderID);

            //purchaseBookHeader.PurchaseBillNo = header.PurchaseBillNo;
            //purchaseBookHeader.VoucherDate = header.VoucherDate;
            //purchaseBookHeader.PurchaseEntryFormID = header.PurchaseEntryFormID;
            //purchaseBookHeader.LedgerTypeCode = header.LedgerTypeCode;
        ...
        private void FrmPurchaseHeaderAmount_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            //purchaseBookHeader.TotalBillAmount = doubleVal;
